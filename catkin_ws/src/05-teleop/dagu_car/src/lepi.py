...
if __name__ == '__main__':
	...
	time.sleep(0.1)
	Lepi.motor_enable(Group.MOTOR_5)
	time.sleep(0.1)
	Lepi.motor_set_speed(Group.MOTOR_1,65000)
	time.sleep(0.1)
	Lepi.motor_set_speed(Group.MOTOR_2,65000)
	time.sleep(0.1)
	Lepi.motor_set_speed(Group.MOTOR_3,65000)
	time.sleep(0.1)
	Lepi.motor_set_speed(Group.MOTOR_4,65000)
	time.sleep(0.1)
	Lepi.motor_set_speed(Group.MOTOR_5,65000)
	time.sleep(2)
	...
	time.sleep(0.1)
	Lepi.motor_disable(Group.MOTOR_5)
