...
class ContAntiInstagramNode():
    def __init__(self):
        ...
        # self.sub_image = rospy.Subscriber('/{}/camera_node/image/compressed'.format(robot_name), CompressedImage, self.cbNewImage, queue_size=1)
        self.sub_image_raw = rospy.Subscriber('/{}/camera_node/image_raw'.format(robot_name), Image, self.cbNewImage, queue_size=1)
