...
class ImageTransformerNode():
    def __init__(self):
        ...
        # self.sub_image = rospy.Subscriber('/{}/camera_node/image/compressed'.format(robot_name), CompressedImage, self.callbackImage, queue_size=1)
        self.sub_image = rospy.Subscriber('/{}/camera_node/image_raw'.format(robot_name), Image, self.callbackImage, queue_size=1)
